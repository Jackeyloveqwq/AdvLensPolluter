...
__all__ = [
    ...
    "fasterrcnn_mobilenet_v3_large_fpn", "fasterrcnn_resnet101_fpn"
]
...
model_urls = {
    ...
    'fasterrcnn_resnet101_fpn_coco':
        'https://download.openxlab.org.cn/models/mmdetection/FasterR-CNN/weight/faster-rcnn_r101_fpn_ms-3x_coco',
...
def fasterrcnn_resnet101_fpn(pretrained=True, progress=True,
    ...
    model = FasterRCNN(backbone, num_classes, **kwargs)
    print('模型的state_dict键值', model.state_dict().keys())
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls['fasterrcnn_resnet101_fpn_coco'],
                                              progress=progress)
        print('预训练权重的state_dict键值', state_dict.keys())
